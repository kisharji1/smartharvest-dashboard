...
export const LeafIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M11 20A7 7 0 0 1 4 13V8a7.999 7.999 0 0 1 10-6 8 8 0 0 1 8 8 7 7 0 0 1-7 7h-1" />
        <path d="M9 22V12" />
    </svg>
);
...
export const SeedlingIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M4 20h16" />
        <path d="M6 20v-4a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v4" />
        <path d="M6 12A4 4 0 0 1 2 8c0-2 2-4 4-4a4 4 0 0 1 4 4c0 2-2 4-4 4Z" />
        <path d="M18 12a4 4 0 0 0 4-4c0-2-2-4-4-4a4 4 0 0 0-4 4c0 2 2 4 4 4Z" />
    </svg>
);
...
export const FertilizerIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="m3 21 3-3" />
        <path d="m10 14 3-3" />
        <path d="M19 12c-3.87 3.87-11.13 3.87-15 0" />
        <path d="M10 18c-3.5-1.5-6-5-6-9" />
        <path d="M14 18c3.5-1.5 6-5 6-9" />
    </svg>
);
...
export const DropletsIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.48-2.26-1.3-3.11-1.5-1.5-1.5-3.14 0-4.68C10.5 3.6 11.2 3 12 3s1.5.6 2.3 1.4c1.5 1.54 1.5 3.18 0 4.68-.82.85-1.3 1.95-1.3 3.11 0 2.22 1.8 4.05 4 4.05" />
        <path d="M12 21a7 7 0 0 0 7-7c0-2.22-1-4.2-2.7-5.7" />
        <path d="M12 21a7 7 0 0 1-7-7c0-2.22 1-4.2 2.7-5.7" />
    </svg>
);
...
export const BugIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        ...
        <path d="M20.97 9c-.1-4-3.57-7-7.47-7" />
        <path d="M4 13H2" />
        <path d="M22 13h-2" />
        <path d="m6 19-2 2" />
        <path d="m18 19 2 2" />
...
export const GovernmentIcon = (props) => (
    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" {...props}>
        <path d="M12 22v-8" />
        <path d="M20 14V5a2 2 0 0 0-2-2H6a2 2 0 0 0-2 2v9h16z" />
        <path d="M4 14h.01" />
        <path d="M20 14h-.01" />
        <path d="M15 14h.01" />
        <path d="M9 14h.01" />
...
// FIX: Add missing InfoIcon and AlertTriangleIcon components

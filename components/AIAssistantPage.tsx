...
import { MicrophoneIcon, SendIcon, ChevronLeftIcon } from './icons';
...
export const AIAssistantPage: React.FC<AIAssistantPageProps> = ({ onBack, onSendMessage, chatHistory, isProcessing, language, setLanguage }) => {

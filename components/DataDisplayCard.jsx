...
import { ThermometerIcon, DropletsIcon, WindIcon, SunIcon, CloudIcon, CloudRainIcon } from './icons.jsx';
...
export const DataDisplayCard = ({ title, data }) => {
    const isWeatherData = (d) => 'current' in d && 'forecast' in d;

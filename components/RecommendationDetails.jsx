...
import { BookOpenIcon, BugIcon, CloudLightningIcon, ClockIcon, ScaleIcon, LayersIcon } from './icons.jsx';

const isAlertsData = (d) => 'alerts' in d && 'guides' in d;
...
export const RecommendationDetails = ({ title, icon, data }) => {
    return (

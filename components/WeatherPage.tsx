...
import { ChevronLeftIcon, LocateIcon, SearchIcon, ShieldAlertIcon } from './icons';
...
interface WeatherPageProps extends PageProps {
    locationStatus: LocationStatus;
    locationName: string;
    weatherData: WeatherData | null;
    alertsAndGuides: AlertsData | null;
    errorMessage: string;
    loadingMessage: string;
    requestLocation: () => void;
    handleManualLocationSearch: (e: React.FormEvent) => void;
    manualLocationInput: string;
    setManualLocationInput: (value: string) => void;
...
export const WeatherPage: React.FC<WeatherPageProps> = (props) => {
